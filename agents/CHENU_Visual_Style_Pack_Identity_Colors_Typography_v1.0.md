# CHE·NU — VISUAL STYLE PACK: Identity, Colors, Typography (v1.0 Canonical)
...
CHE-NU_VISUAL_STYLE_PACK:
  ...
  description: "Official CHE·NU visual identity and styling framework. Universal across 2D, 3D, XR."
...
textures_surface:
  ...
  card_satin: "soft specular reflection at 10° angle"
```
...
```yaml
motion_effects:
  zoom_in_sphere: "scale 0.92 → 1.00"
  panel_slide_up: "translateY(20px) → 0px"
...
## 13) COLOR SUMMARY TABLE ⚡

```
┌──────────────────────────────────────────────────────────────────────────┐
│                      CHE·NU SPHERE COLORS                                 │
├──────────────────────────────────────────────────────────────────────────┤
│                                                                           │
│  SPHERE           │ HEX       │ DESCRIPTION                              │
│  ─────────────────┼───────────┼───────────────────────────────────────── │
│  PERSONAL         │ #76E6C7   │ Vert menthe - Vie personnelle            │
│  BUSINESS         │ #5BA9FF   │ Bleu corporate - Affaires                │
│  SCHOLAR          │ #E0C46B   │ Or savoir - Apprentissage                │
│  CREATIVE         │ #FF8BAA   │ Rose créatif - Créativité                │
│  SOCIAL           │ #66D06F   │ Vert social - Relations                  │
│  INSTITUTIONS     │ #D08FFF   │ Violet institutionnel - Gouvernement     │
│  METHODOLOGY      │ #59D0C6   │ Cyan méthodique - Systèmes               │
│  XR               │ #8EC8FF   │ Bleu XR - Immersif                       │
│  ENTERTAINMENT    │ #FFB04D   │ Orange divertissement - Loisirs          │
│  AI_LAB           │ #FF5FFF   │ Magenta IA - Expérimentation             │
│  MY_TEAM          │ #5ED8FF   │ Bleu équipe - Collaboration              │
│                                                                           │
└──────────────────────────────────────────────────────────────────────────┘
```
